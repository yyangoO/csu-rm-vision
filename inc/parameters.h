...
public:
    ...
    struct ArmorMonoProcVal_t {
        ...
        float armor_length_mid_x_diff_small_l;
        float armor_length_mid_x_diff_small_h;
        float armor_length_mid_x_diff_big_l;
        float armor_length_mid_x_diff_big_h;
    ...
    struct RuneMonoProcVal_t {
        ...
        float target_fan_retio_l;
        float target_fan_retio_h;
    };
